        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            ...
            <span className="navbar-text d-none d-lg-block">
              <a className="btn btn-outline-light ms-2" href="https://github.com/aul-kamalkishore/skills-build-applications-w-copilot-agent-mode" target="_blank" rel="noopener noreferrer">GitHub Repo</a>
            </span>
          </div>
        </div>
      </nav>
            ...
            <div className="text-center mt-5">
              <div className="card mx-auto" style={{maxWidth: 500}}>
                <div className="card-body">
                  <h1 className="card-title mb-3">Welcome to <span className="text-primary">Octofit Tracker</span>!</h1>
